...
public class RemoveEmployeeInternalFrame extends javax.swing.JInternalFrame {

    
    Connection con = null;
    public RemoveEmployeeInternalFrame() {
        initComponents();
        String user = "root";
        String pass = "root";
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(763, 82));
        ...
        jLabel1.setText("REMOVING AN EMPLOYEE");
        ...
        jLabel2.setText("Enter The Employee ID to Delete :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String sql = "DELETE FROM junaiddb.employee WHERE (EmployeeSID = ?)";
        try {
