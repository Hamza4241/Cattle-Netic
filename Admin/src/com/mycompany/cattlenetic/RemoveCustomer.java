...
public class RemoveCustomer extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REMOVING A CUSTOMER");

        jPanel4.setBackground(new java.awt.Color(122, 102, 255));
        ...
        jLabel2.setText("Enter a Customer ID to Delete");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "DELETE FROM junaiddb.customer WHERE (ID = ?)";
        try {
